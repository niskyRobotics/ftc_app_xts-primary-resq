...
public class ThunkedI2cController implements I2cController, IThunkWrapper<I2cController> {
    ...
    @Override
    public I2cController getWrappedTarget() {
        return this.target;
    }
    ...
    @Override
    public synchronized void readI2cCacheFromModule(final int physicalPort)
    ...
    @Override
    public synchronized void writeI2cCacheToModule(final int physicalPort)
    // Synchronized is necessary to avoid possible double queue insertion of segment
    {
    ...
    @Override
    public synchronized void writeI2cPortFlagOnlyToModule(final int physicalPort)
    // Synchronized is necessary to avoid possible double queue insertion of segment
    {
     ...
     */
    @Override
    public synchronized void registerForI2cPortReadyCallback(final I2cController.I2cPortReadyCallback callback, final int physicalPort) {
     ...
     */
    @Override
    public synchronized void deregisterForPortReadyCallback(final int physicalPort) {
