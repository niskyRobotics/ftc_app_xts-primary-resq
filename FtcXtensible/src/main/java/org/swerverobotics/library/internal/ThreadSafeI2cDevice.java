...
public class ThreadSafeI2cDevice extends I2cDevice
    ...
    @Override synchronized public void enableI2cReadMode(int i2cAddr, int memAddress, int length)
        {
        super.enableI2cReadMode(i2cAddr, memAddress, length);
        }

    @Override synchronized public void enableI2cWriteMode(int i2cAddr, int memAddress, int length)
        {
        super.enableI2cWriteMode(i2cAddr, memAddress, length);
        }
